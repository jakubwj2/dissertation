...
In summary, the dissertation delivered a system for synthesising realistic student data. It also created a publicly available website at https://dissertation.jakubwj.com.

The answer to the research questions stated in the aims and objectives:

\begin{itemize}

    \item The experiments in the dissertation showed that knowledge tracing algorithms can be effectively trained and evaluated on LLM-generated data, and their relative rankings broadly match those on ASSISTments2009.

    \item The Diagnostic Transformer (DTransformer) consistently achieved the highest AUC score, indicating it’s the strongest model for the current synthetic user setup.

    \item The model rankings between synthetic and real data suggest that LLM-generated interactions can act as a proxy for real data when benchmarking or prototyping KT models, within the limitations of this dissertation.
